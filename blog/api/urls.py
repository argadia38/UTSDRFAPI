...
from .views import CategoryViewSet, ProductViewSet, OrderViewSet, OrderDetailViewSet,TableCountsView
...
urlpatterns = [
    ...
    path('table-counts/', TableCountsView.as_view(), name='table-counts'),
] 
